...
const ProductVideoCard = forwardRef(({ video, isActive = false }, ref) => {
  ...
  const handleClick = () => {
    if (video.productId?._id) {
      navigate(`/products/${video.productId._id}`);
    }
  };

  return (
    <div
      className="relative w-full overflow-hidden rounded-2xl cursor-pointer group bg-black"
    ...
    >
      ...
      {/* Bottom Info Overlay */}
      <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/80 via-black/40 to-transparent p-4 pb-6">
...
ProductVideoCard.displayName = 'ProductVideoCard';
